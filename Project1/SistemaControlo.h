...
/*Devolve uma listagem com quais os alunos por cada UC*/
TListagem* ListagemPorUC();

/*Devolve uma listagem com quais as cadeiras em que cada aluno está inscrito*/
TListagem* ListagemPorAluno();

TListagem* ListagemUCmenos5Alunos(int ano);

/*Devolve uma listagem de horas por aluno. Esta é uma estimativa de horas baseado no número de ECTS a 
que um aluno está inscrito num ano.*/
TListagem* ListagemHorasPorAluno(int ano);

// Devolve listagem com numero de alunos por país de residencia
